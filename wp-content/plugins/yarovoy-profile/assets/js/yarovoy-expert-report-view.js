...
document.addEventListener('DOMContentLoaded', function () {
    var btn = document.getElementById('yarovoy-expert-report-view-btn');
    if (!btn) return;
    btn.addEventListener('click', function (e) {
        e.preventDefault();
        var reportIdInput = document.getElementById('yarovoy-expert-report-id');
        ...
        var url = '/wp-json/yarovoy/v1/profile/expert/report/view/' + reportId;
        var headers = {};
