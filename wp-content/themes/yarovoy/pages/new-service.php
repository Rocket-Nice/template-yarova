...
<div class="page-container container">
        ...
        <div class="cases__slider overflow-hidden">
          ...
          if ($auto_keys) {
            usort($auto_keys, function ($a, $b) {
              $a_price = is_numeric($a["price_benefit"]) ? (float)$a["price_benefit"] : 0;
              $b_price = is_numeric($b["price_benefit"]) ? (float)$b["price_benefit"] : 0;
  ...
  <section class="land-section" id="section-faq">
    <div class="land-section__head text-center">
      <h2 class="land-section__title">FAQ</h2>
    </div>
    <div class="land-faq">
      <?php
  ...
  <div class="modal__square">
    ...
    <div class="modal__body">
      <form class="form modal__form" method="POST">
        ...
        <button class="btn l-btn btn--accent form__send" type="submit">Оставить заявку</button>
      </form>
    </div>
  </div>
</div>
