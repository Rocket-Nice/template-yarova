<div class="popup popup-code" id="popup-code">
	<div class="popup__wrapper">
		<div class="popup__content">
			<div class="popup-code__content">
				<div class="popup-code__title">Подтвердите номер телефона</div>
				<div class="popup-code__text">
					Чтобы завершить регистрацию введите код активации из смс.
				</div>
				<div class="form popup-code__form">
					<div class="input">
						<input type="number" name="code" class="input__cell" max="4" placeholder="Введите код из СМС">
						<div class="input__timer">100 с</div>
					</div>
					<div class="code__repeat"></div>
					<button class="popup-code__btn btn btn--accent btn--wide btn--huge">Отправить</button>
