	...
	<div class="container footer__container">
		<div class="footer__panel">
			<a class="footer__logo" href="/">
				<img class="footer__logo-img" src="<?= YAR_THEME_ASSETS; ?>/img/icons/logo.svg" width="268" height="55" alt="ЯПодбор">
			</a>
			<div class="commun footer__commun">
				<div class="commun__item commun__item--phone">
					...
					<button class="btn--reset commun__item-btn" aria-label="Open modal" data-popup="popup-feedback">Перезвоните мне</button>
				</div>
			</div>
		...
		<div class="footer__row">
					...
					<li class="footer__nav-item">
						...
						<ul class="footer__nav-child-list">
							<li class="footer__nav-child-item">
								<a class="footer__nav-child-link" href="<?= ( is_user_logged_in() ? '/profile/' : '/login/' ); ?>">Личный кабинет клиента</a></li>
							<li class="footer__nav-child-item">
							...
							<li class="footer__nav-child-item">
								<a class="footer__nav-child-link" href="#!">Договор купли-продажи авто</a>
							</li>
						</ul>
					</li>
				</ul>
			...
			<div class="footer__panel-btns btns-spacer hide-sm-only">
				<a class="btn btn--accent footer__panel-btn" href="#!">Получить консультацию</a>
				<a class="btn btn--border-light footer__panel-btn" href="/platform/catalog/">Выбрать эксперта</a>
			</div>
		</div>
...
<!-- calltouch
<script>
    (function(w,d,n,c){w.CalltouchDataObject=n;w[n]=function(){w[n]["callbacks"].push(arguments)};if(!w[n]["callbacks"]){w[n]["callbacks"]=[]}w[n]["loaded"]=false;if(typeof c!=="object"){c=[c]}w[n]["counters"]=c;for(var i=0;i<c.length;i+=1){p(c[i])}function p(cId){var a=d.getElementsByTagName("script")[0],s=d.createElement("script"),i=function(){a.parentNode.insertBefore(s,a)},m=typeof Array.prototype.find === 'function',n=m?"init-min.js":"init.js";s.async=true;s.src="https://mod.calltouch.ru/"+n+"?id="+cId;if(w.opera=="[object Opera]"){d.addEventListener("DOMContentLoaded",i,false)}else{i()}}})(window,document,"ct","w2a9o34e");
</script>
calltouch -->
