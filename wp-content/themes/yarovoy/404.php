<?php get_header(); ?>
    <div class="page-container container">
      <section class="section section--404">
        <div class="section__img-bg--wrap anim-elem"><img class="section__img-bg" src="<?= YAR_THEME_ASSETS; ?>/img/content/banner/404-bg.png" width="1920" height="1080" alt="404"></div>
        <div class="error-404">
