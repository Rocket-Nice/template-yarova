...
class Kama_Breadcrumbs {
	...
	static $args = [
		...
		'title_patt'      => '<li class="kb_title breadcrumbs__item"><a href="#" class="breadcrumbs__link">%s</a></li>',
	...
	function get_crumbs( $sep, $l10n, $args ) {
		...
		if ( 1 ) {
			...
			if ( ! $mark ) {
				$mark = [
					'wrappatt'  => '<div class="breadcrumbs"><ul class="breadcrumbs__list">%s</ul></div>',
			...
			elseif ( $mark === 'rdf.data-vocabulary.org' ) {
				$mark = [
					'wrappatt'  => '<div class="breadcrumbs" prefix="v: http://rdf.data-vocabulary.org/#"><ul class="breadcrumbs__list">%s</ul></div>',
					'linkpatt'  => '<li class="breadcrumbs__item" typeof="v:Breadcrumb"><a href="%s" rel="v:url" property="v:title"  class="breadcrumbs__link">%s</a>',
					'sep_after' => '</li>', // close span after the separator!
				];
			} // schema.org
			elseif ( $mark === 'schema.org' ) {
				$mark = [
					'wrappatt'  => '<div class="breadcrumbs" itemscope itemtype="http://schema.org/BreadcrumbList"><ul class="breadcrumbs__list">%s</ul></div>',
					'linkpatt'  => '<li class="breadcrumbs__item" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a class="breadcrumbs__link" href="%s" itemprop="item"><span itemprop="name">%s</span></a></li>',
					'sep_after' => '',
				];
