...
register_nav_menus([
	...
	'footer_lk'  => 'Футер: Личный кабинет',
	'footer_dop'  => 'Футер: Дополнительно',
]);
...
// Добавил тут сортировку через админку по индексу
function add_menu_order_to_services()
{
	add_post_type_support('service', 'page-attributes');
}
add_action('init', 'add_menu_order_to_services');
...
require_once __DIR__ . '/functions/search-expert-and-client.php';
